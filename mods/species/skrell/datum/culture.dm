/decl/cultural_info/culture/skrell
	...
	description = "Considered as the leaders of Skrellkind, the Qerr-Katish are the face \
		...
		famously long, reaching down to nearly their waists. The Qerr Katish's Psionic potential allows them to communicate with other beings \
		through their mind, aswell as sense the emotions and thoughts of those nearby, to \
		an extent. Some Qerr Katish are also able to read the minds of others with their \
		Psionic potential, but this requires a great amount of concentration on their behalf."
	economic_power = 1.4
...
/decl/cultural_info/culture/skrell/caste_talum
	...
	description = "Considering the Skrells' emphasis on functionality and practicality, one would be mistaken to think they do not consider arts much. \
		...
		some Talum are also able to manipulate light in order to make their artistic works look even more incredible, and \
		their melodies, when sung, can be imbued with psionic energy to make those who hear it experience a range of different emotions and feelings, including plants!"
	economic_power = 1.3
...
/decl/cultural_info/culture/skrell/caste_raskinta
	...
	description = "Rarely seen outside the skrellian society, the Raskinta-Katish are however recognised and respected by their entire species, for \
		...
		Raskinta headtails are extremely short, and this caste possesses four rather than three headtails, with the one in the back split into two. Uniquely among Raskinta, \
		loss of a headtail is not seen as disfiguring, especially if it was lost in battle, and while many of them choose to procure repair surgeries, some do not. \
		A Raskinta's psionic prowess can accumulate and manifest itself by increasing their physical capabilities, \
		be it by enhancing their situational awareness, movement, pain tolerance, strength and so on, often depending \
		on the Skrell's line of work."
