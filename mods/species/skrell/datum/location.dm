...
/decl/cultural_info/location/skrellspace
	...
	rather than a Qrii-Skria. Life in these circumstances is often more regimented and disciplined, with a stronger emphasis on community and collaboration, with varying extremes \
	depending on the status, funding and level of military engagements the SDTF is currently in. Such lifestyles are often more common near the Ascent-Skrell border."
	capital = "None"
...
/decl/cultural_info/location/free
	name = "Skrell Space"
	description = "Skrell space is vast and filled with different stars and planets, which may have different levels of skrell presence in them. \
	This presence may amount to small research complexes in the fringe edges of the Skrell border, orbital habitats or large city-states in otherwise less noteworthy systems and planets. "
	capital = "None"
	ruling_body = "None"
...
/decl/cultural_info/location/gilkrolqarr
	...
	underground fauna and flora. Despite it's radius being about three times that of Qerr'Balak, the giant, superhabitable 'karst-world' has an abnormally low gravity and is incapable \
	...
	inhabitants, and ten billion more living in orbital facilities around the system."
	capital = "None"
	ruling_body = "None"
...
/decl/cultural_info/location/harrkelm
	name = "Harr'Kelm"
	description = "Surprisingly militarized and traditional, The system of Harr'Kelm is an important base of operations for Yii'talana and, if needed, other SDTFs who may require \
	resupply. The Skrell of Harr'Kelm are under the ruling of a SDTF Commander, and they live a comfortable, safe and very disciplined life where the sight of their \
	Raskinta kin is very common, along with the impressive vessels maintained by Qarr-Morr'kon fleets. Planetary presence is often semi-permanent \
	at best for research or resource extraction, and the majority of skrell here live in orbital habitats."
	capital = "None"
	ruling_body = "None"
...
/decl/cultural_info/location/ueorsi
	...
	description = "Ue'Orsi, or 'No Honor', is the oldest, largest, and most politically stable of the Ue-Katish flotillas. Founded almost six hundred years ago as a \
	 Ue-Katish citizen’s militia, Ue'Orsi has been continually growing, improving its internal infrastructure, and moving rimward in the face of expansion by \
