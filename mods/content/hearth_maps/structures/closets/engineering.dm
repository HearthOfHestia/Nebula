...
/decl/closet_appearance/secure_closet/endeavour/engineering
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_WARM_YELLOW,
		"exped" = COLOR_WARM_YELLOW
	)

/decl/closet_appearance/secure_closet/endeavour/engineering/atmos
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/endeavour/engineering/se
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/endeavour/engineering/ce
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_WARM_YELLOW,
...
/obj/structure/closet/secure_closet/engineering_chief_endeavour
	name = "chief engineer's locker"
	req_access = list(access_ce)
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/engineering/ce

/obj/structure/closet/secure_closet/engineering_chief_endeavour/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/engineering_endeavour
	name = "engineer's locker"
	req_access = list(access_engine_equip)
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/engineering

/obj/structure/closet/secure_closet/engineering_endeavour/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/engineering_senior
	...
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/engineering/se
...
/obj/structure/closet/secure_closet/atmos_endeavour
	name = "atmospherics equipment locker"
	req_access = list(access_atmospherics)
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/engineering/atmos

/obj/structure/closet/secure_closet/atmos_endeavour/WillContain()
	return list(
		/obj/item/clothing/under/hazard,
