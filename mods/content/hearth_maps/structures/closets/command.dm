 ...
 * Endeavour Command
 */
/decl/closet_appearance/secure_closet/endeavour/command
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_CLOSET_GOLD
	)

/decl/closet_appearance/secure_closet/endeavour/command/bo
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_CLOSET_GOLD,
		"stripe_vertical_right_full" = COLOR_CLOSET_GOLD
	)

/decl/closet_appearance/secure_closet/endeavour/command/xo
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_CLOSET_GOLD,
		"stripe_vertical_right_full" = COLOR_CLOSET_GOLD,
...
/decl/closet_appearance/secure_closet/endeavour/command/co
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_CLOSET_GOLD,
...
/obj/structure/closet/secure_closet/CO
	...
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/command/co

/obj/structure/closet/secure_closet/CO/WillContain()
	return list(
		/obj/item/radio/headset/heads/endeavourexec,
		/obj/item/clothing/glasses/sunglasses,
		/obj/item/radio/headset/heads/endeavourexec/alt,
...
/obj/structure/closet/secure_closet/XO
	...
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/command/xo
...
/obj/structure/closet/secure_closet/sea
	...
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/command
...
/obj/structure/closet/secure_closet/bridgeofficer
	...
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/command/bo
