 ...
 * Endeavour Science
 */
/decl/closet_appearance/secure_closet/endeavour/science
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/endeavour/science/cso
...
/obj/structure/closet/secure_closet/RD_endeavour
	name = "chief science officer's locker"
	req_access = list(access_rd)
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/science/cso

/obj/structure/closet/secure_closet/RD_endeavour/WillContain()
	return list(
		...
		/obj/item/radio/headset/heads/endeavourntdirector,
		/obj/item/radio/headset/heads/endeavourntdirector/alt,
...
/obj/structure/closet/secure_closet/secure_closet/xenoarchaeologist_endeavour
	name = "xenoarchaeologist's locker"
	req_access = list(access_xenoarch)
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/science

/obj/structure/closet/secure_closet/secure_closet/xenoarchaeologist_endeavour/WillContain()
	return list(
		...
		/obj/item/radio/headset/endeavournanotrasen,
		/obj/item/clothing/mask/gas,
		/obj/item/clipboard,
		/obj/item/folder,
		/obj/item/taperecorder,
...
/obj/structure/closet/secure_closet/scientist_endeavour
	name = "researcher's locker"
	req_access = list(access_research)
	closet_appearance = /decl/closet_appearance/secure_closet/endeavour/science

/obj/structure/closet/secure_closet/scientist_endeavour/WillContain()
	return list(
		///obj/item/clothing/under/color/white,
		/obj/item/clothing/suit/storage/toggle/labcoat/science,
		/obj/item/clothing/suit/storage/toggle/labcoat,
