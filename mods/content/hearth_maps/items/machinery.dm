//Shouldn't be a lot in here, only endeavour versions of existing machines that need a different access req or something along those lines.

/obj/machinery/vending/medical/endeavour
	req_access = list(access_medical)

/obj/machinery/drone_fabricator/endeavour
	fabricator_tag = "ISEO Endeavour Maintenance"

/obj/machinery/drone_fabricator/endeavour/adv
	name = "advanced drone fabricator"
	fabricator_tag = "SFV Arrow Maintenance"
	drone_type = /mob/living/silicon/robot/drone/construction

//telecommunications gubbins for endeavour-specific networks
