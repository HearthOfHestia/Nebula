/obj/item/clothing/head/helmet/pilot/alternate
	...
	icon = 'mods/content/hearth_maps/icons/borrowed_icons/pilot/helmet.dmi'
	var/open = FALSE
...
/obj/item/clothing/head/helmet/pilot/alternate/mobius
	icon = 'mods/content/hearth_maps/icons/borrowed_icons/pilot/mobius.dmi'

/obj/item/clothing/head/helmet/pilot/alternate/viper
	icon = 'mods/content/hearth_maps/icons/borrowed_icons/pilot/viper.dmi'

/obj/item/clothing/head/helmet/pilot/alternate/luke
	icon = 'mods/content/hearth_maps/icons/borrowed_icons/pilot/luke.dmi'

/obj/item/clothing/head/helmet/pilot/alternate/shark
	icon = 'mods/content/hearth_maps/icons/borrowed_icons/pilot/shark.dmi'

/obj/item/clothing/head/helmet/pilot/alternate/corvid
	icon = 'mods/content/hearth_maps/icons/borrowed_icons/pilot/corvid.dmi'

/obj/item/clothing/head/helmet/pilot/alternate/ace
	icon = 'mods/content/hearth_maps/icons/borrowed_icons/pilot/ace.dmi'

/obj/item/clothing/head/helmet/pilot/alternate/checker
	icon = 'mods/content/hearth_maps/icons/borrowed_icons/pilot/checker.dmi'
