/obj/item/book/manual/solgov_law
	name = "ISEO Legal Code"
	desc = "A brief overview of ISEO regulations."
	icon_state = "bookSolGovLaw"
	author = "The International Stellar Exploration Organisation"
	title = "ISEO Legal Code"
...
/obj/item/folder/envelope/captain/LateInitialize()
	..()
	var/obj/effect/overmap/visitable/endeavour = global.overmap_sectors["[z]"]
	var/memo = {"
	...
	The current docking code is: [endeavour.docking_codes]<br>
