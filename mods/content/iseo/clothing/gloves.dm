...
/obj/item/clothing/gloves/duty/com
	...
	icon = 'mods/content/iseo/icons/gloves/duty_gloves_command.dmi'

/obj/item/clothing/gloves/duty/eng
	name = "engineering duty gloves"
	icon = 'mods/content/iseo/icons/gloves/duty_gloves_engineering.dmi'

/obj/item/clothing/gloves/duty/sec
	name = "security duty gloves"
	icon = 'mods/content/iseo/icons/gloves/duty_gloves_security.dmi'

/obj/item/clothing/gloves/duty/sci
	name = "exploration duty gloves"
	icon = 'mods/content/iseo/icons/gloves/duty_gloves_science.dmi'

/obj/item/clothing/gloves/duty/med
	name = "medical duty gloves"
	icon = 'mods/content/iseo/icons/gloves/duty_gloves_medical.dmi'

/obj/item/clothing/gloves/duty/srv
	name = "service duty gloves"
	icon = 'mods/content/iseo/icons/gloves/duty_gloves_service.dmi'

/obj/item/clothing/gloves/duty/sup
	name = "supply duty gloves"
	icon = 'mods/content/iseo/icons/gloves/duty_gloves_supply.dmi'