/datum/job/pathfinder
	...
	access = list(
		...
		access_opportunity_helm, access_iseo_crew, access_expedition_shuttle, access_expedition_shuttle_helm,
...
/datum/job/explorer
	...
	access = list(
		...
		access_opportunity_helm, access_iseo_crew, access_expedition_shuttle, access_opportunity, access_hangar,
