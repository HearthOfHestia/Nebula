...
/var/global/const/access_opportunity_helm = "ACCESS_TORCH_GUP_HELM" //76
...
/var/global/const/access_perseverance = "ACCESS_TORCH_PERSEVERANCE" //78
/datum/access/perseverance
	id = access_perseverance
	desc = "Perseverance"
	region = ACCESS_REGION_GENERAL

/var/global/const/access_perseverance_helm = "ACCESS_TORCH_PERSEVERANCE_HELM" //79
...
/var/global/const/access_opportunity = "ACCESS_TORCH_GUP" //89
...
* NRV Curiosity *
*************/
/var/global/const/access_curiosity = "ACCESS_TORCH_CURIOSITY" //200
/datum/access/curiosity
	id = access_curiosity
	desc = "Curiosity"
	region = ACCESS_REGION_NT

/var/global/const/access_curiosity_helm = "ACCESS_TORCH_CURIOSITY_HELM" //201
/datum/access/curiosity_helm
	id = access_curiosity_helm
	desc = "Curiosity Helm"
	region = ACCESS_REGION_NT

/var/global/const/access_curiosity_analysis = "ACCESS_TORCH_CURIOSITY_ANALYSIS" //202
/datum/access/curiosity_analysis
	id = access_curiosity_analysis
	desc = "Curiosity Analysis Lab"
	region = ACCESS_REGION_NT

/var/global/const/access_curiosity_phoron = "ACCESS_TORCH_CURIOSITY_PHORON" //203
/datum/access/curiosity_phoron
	id = access_curiosity_phoron
	desc = "Curiosity Phoron Sublimation Lab"
	region = ACCESS_REGION_NT

/var/global/const/access_curiosity_toxins = "ACCESS_TORCH_CURIOSITY_TOXINS" //204
/datum/access/curiosity_toxins
	id = access_curiosity_toxins
	desc = "Curiosity Toxins Lab"
	region = ACCESS_REGION_NT

/var/global/const/access_curiosity_chemistry = "ACCESS_TORCH_CURIOSITY_CHEMISTRY" //205
/datum/access/curiosity_chemistry
	id = access_curiosity_chemistry
	desc = "Curiosity Chemistry Lab"
	region = ACCESS_REGION_NT

/var/global/const/access_curiosity_rd = "ACCESS_TORCH_CURIOSITY_RD" //206
/datum/access/curiosity_rd
	id = access_curiosity_rd
	desc = "Curiosity Chief Science Officer's Office"
	region = ACCESS_REGION_NT

/var/global/const/access_curiosity_security = "ACCESS_TORCH_CURIOSITY_SEC" //207
/datum/access/curiosity_security
	id = access_curiosity_security
	desc = "Curiosity Security Office"
	region = ACCESS_REGION_NT

/var/global/const/access_curiosity_maint = "ACCESS_TORCH_CURIOSITY_MAINT" //208
