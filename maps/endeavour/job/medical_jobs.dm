/datum/job/senior_doctor
	...
	alt_titles = list(
		"Surgeon")
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/medical/senior
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/medical/senior/fleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/endeavour/crew/medical/senior/civilian
	)
	allowed_ranks = list(
	...
	access = list(
		...
		access_medical_equip, access_iseo_crew, access_senmed, access_radio_med
	)
...
/datum/job/junior_doctor
	...
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/medical/junior/fleet
	)
	allowed_ranks = list(
...
/datum/job/doctor
	...
	alt_titles = list(
		"Paramedic",
		"Corpsman")
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/medical/doctor
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/medical/doctor/fleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/endeavour/crew/medical/doctor/civilian
	)
	allowed_ranks = list(
	...
	access = list(
		...
		access_iseo_crew, access_hangar, access_radio_med
	)
...
/datum/job/medical_trainee
	...
	access = list(
		access_medical, access_morgue, access_maint_tunnels,
		access_external_airlocks, access_emergency_storage,
		access_surgery, access_medical_equip, access_iseo_crew,
		access_radio_med
	)
...
/datum/job/chemist
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/medical/chemist
	...
	access = list(
		...
		access_medical_equip, access_iseo_crew, access_chemistry,
...
/datum/job/psychiatrist
	...
	minimal_player_age = 0
	supervisors = "the Chief Medical Officer"
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/medical/counselor
	alt_titles = list(
		"Psychiatrist",
		"Psionic Counselor" = /decl/hierarchy/outfit/job/endeavour/crew/medical/counselor/mentalist,
		"Mentalist" = /decl/hierarchy/outfit/job/endeavour/crew/medical/counselor/mentalist

	)

	allowed_branches = list(
		/datum/mil_branch/iseo_issc = /decl/hierarchy/outfit/job/endeavour/crew/medical/counselor/fleet,
	...
	access = list(
		...
		access_iseo_crew, access_medical_equip, access_radio_med
	)
