/datum/job/senior_engineer
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/engineering/senior_engineer
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/engineering/senior_engineer/espatier
	)
	allowed_ranks = list(
	...
	access = list(
		...
		access_tcomsat, access_iseo_crew, access_seneng, access_hangar, access_network, access_radio_eng
	)
...
/datum/job/engineer
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/engineering/engineer
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/engineering/engineer/espatier,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/endeavour/crew/engineering/engineer/contractor,
	)
	allowed_ranks = list(
	...
	access = list(
		access_engine, access_engine_equip, access_maint_tunnels, access_external_airlocks, access_emergency_storage,
		access_teleporter, access_eva, access_tech_storage, access_atmospherics, access_janitor, access_construction,
		access_iseo_crew, access_hangar, access_radio_eng
	)
...
/datum/job/roboticist
	...
	alt_titles = list(
		"Mechsuit Technician")
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/engineering/roboticist
	allowed_branches = list(
		/datum/mil_branch/civilian,
		/datum/mil_branch/iseo_issc = /decl/hierarchy/outfit/job/endeavour/crew/engineering/roboticist/iseo,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/engineering/roboticist/espatier
	)
	allowed_ranks = list(
	...
	access = list(
		access_robotics, access_engine, access_iseo_crew, access_radio_eng
	)
