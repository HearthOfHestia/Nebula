/datum/job/pathfinder
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/exploration/pathfinder

	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/exploration/pathfinder/espatier
	)
	allowed_ranks = list(
...
/datum/job/nt_pilot
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/exploration/pilot
	allowed_branches = list(
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/exploration/pilot/espatier,
		/datum/mil_branch/iseo_issc,
	)
	allowed_ranks = list(
		/datum/mil_rank/sc/s2,
...
/datum/job/explorer
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/exploration/explorer
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/exploration/explorer/espatier
	)
