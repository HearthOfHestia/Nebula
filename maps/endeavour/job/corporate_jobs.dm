/datum/job/liaison
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/passenger/workplace_liaison
	...
	access = list(
		...
		access_corporate, access_endeavour_fax,
...
/datum/job/bodyguard
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/passenger/corporate_bodyguard
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/contractor)
	...
	access = list(
		access_liaison, access_bridge, access_iseo_crew,
		access_corporate, access_sec_guard, access_endeavour_fax,
		access_radio_serv
	)
