/datum/job/warden
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/security/brig_chief
	department_types = list(/decl/department/security)
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/security/brig_chief/espatier
	)
	allowed_ranks = list(
	...
	access = list(
		...
		access_eva, access_sec_doors, access_iseo_crew, access_endeavour_fax,
		access_radio_sec
	)
...
/datum/job/detective
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/security/forensic_tech
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/security/forensic_tech/espatier
	)
	allowed_ranks = list(
...
/datum/job/officer
	...
	outfit_type = /decl/hierarchy/outfit/job/endeavour/crew/security/maa
	allowed_branches = list(
		/datum/mil_branch/iseo_issc,
		/datum/mil_branch/espatier_corps = /decl/hierarchy/outfit/job/endeavour/crew/security/maa/espatier
	)
	allowed_ranks = list(
		/datum/mil_rank/sc/t2,
		/datum/mil_rank/sc/t3,
